...
code: SOURCE_COVERAGE_TERMINAL_COUNT_MISMATCH
source: error/catalog.json
generated: true
---

# SOURCE_COVERAGE_TERMINAL_COUNT_MISMATCH — Source coverage terminal count mismatch
...
The source coverage terminal count evidence is internally inconsistent or does not match its bound identity.
