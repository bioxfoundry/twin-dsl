...
code: GEOMETRY_DEPENDENCY_REVISION_MISMATCH
source: error/catalog.json
generated: true
---

# GEOMETRY_DEPENDENCY_REVISION_MISMATCH — Geometry dependency revision mismatch
...
The geometry dependency evidence is internally inconsistent or does not match its bound identity.
