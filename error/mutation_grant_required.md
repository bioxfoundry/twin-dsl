...
code: mutation_grant_required
source: error/catalog.json
generated: true
---

# mutation_grant_required — Mutation grant required
...
The mutation grant operation was refused by an explicit safety or authority boundary.
