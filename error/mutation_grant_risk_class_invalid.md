...
code: mutation_grant_risk_class_invalid
source: error/catalog.json
generated: true
---

# mutation_grant_risk_class_invalid — Mutation grant risk class invalid
...
The mutation grant risk class operation was refused by an explicit safety or authority boundary.
