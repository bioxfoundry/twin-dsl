...
code: PROCESS_STEP_ID_DUPLICATE
source: error/catalog.json
generated: true
---

# PROCESS_STEP_ID_DUPLICATE — Process step id duplicate
...
The process step id evidence is internally inconsistent or does not match its bound identity.
