...
code: mutation_grant_target_mismatch
source: error/catalog.json
generated: true
---

# mutation_grant_target_mismatch — Mutation grant target mismatch
...
The mutation grant target operation was refused by an explicit safety or authority boundary.
