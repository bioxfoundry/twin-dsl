...
code: SCENE_SOURCE_TWIN_MISMATCH
source: error/catalog.json
generated: true
---

# SCENE_SOURCE_TWIN_MISMATCH — Scene source twin mismatch
...
The scene source twin evidence is internally inconsistent or does not match its bound identity.
