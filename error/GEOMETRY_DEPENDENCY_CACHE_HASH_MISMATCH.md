...
code: GEOMETRY_DEPENDENCY_CACHE_HASH_MISMATCH
source: error/catalog.json
generated: true
---

# GEOMETRY_DEPENDENCY_CACHE_HASH_MISMATCH — Geometry dependency cache hash mismatch
...
The geometry dependency cache evidence is internally inconsistent or does not match its bound identity.
