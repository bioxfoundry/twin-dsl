...
code: SOURCE_COVERAGE_RESOURCE_URI_HASH_MISMATCH
source: error/catalog.json
generated: true
---

# SOURCE_COVERAGE_RESOURCE_URI_HASH_MISMATCH — Source coverage resource uri hash mismatch
...
The source coverage resource uri evidence is internally inconsistent or does not match its bound identity.
