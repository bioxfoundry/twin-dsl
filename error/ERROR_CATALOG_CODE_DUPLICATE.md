...
code: ERROR_CATALOG_CODE_DUPLICATE
source: error/catalog.json
generated: true
---

# ERROR_CATALOG_CODE_DUPLICATE — Error catalog code duplicate
...
The error catalog code evidence is internally inconsistent or does not match its bound identity.
