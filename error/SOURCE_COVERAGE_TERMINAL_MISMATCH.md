...
code: SOURCE_COVERAGE_TERMINAL_MISMATCH
source: error/catalog.json
generated: true
---

# SOURCE_COVERAGE_TERMINAL_MISMATCH — Source coverage terminal mismatch
...
The source coverage terminal evidence is internally inconsistent or does not match its bound identity.
