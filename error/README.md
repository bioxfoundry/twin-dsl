...
| [ARCHIVE_ENTRY_READ_FAILED](./ARCHIVE_ENTRY_READ_FAILED.md) | archive | state | false |
| [ARCHIVE_FILE_LIMIT](./ARCHIVE_FILE_LIMIT.md) | archive | state | true |
| [ARCHIVE_FINDING_SUMMARY](./ARCHIVE_FINDING_SUMMARY.md) | archive | state | false |
...
| [ARCHIVE_READ_PARTIAL](./ARCHIVE_READ_PARTIAL.md) | archive | state | false |
| [ARCHIVE_SELECTED_TEXT_BINARY_CONTENT](./ARCHIVE_SELECTED_TEXT_BINARY_CONTENT.md) | archive | state | false |
...
| [BINARY_STREAM_HASHED](./BINARY_STREAM_HASHED.md) | binary | state | false |
| [BINARY_STUB](./BINARY_STUB.md) | binary | state | false |
...
| [DASHBOARD_LISTEN_FAILED](./DASHBOARD_LISTEN_FAILED.md) | dashboard | state | false |
| [DASHBOARD_PORT_CONFLICT](./DASHBOARD_PORT_CONFLICT.md) | dashboard | state | false |
| [DASHBOARD_PORT_FREE](./DASHBOARD_PORT_FREE.md) | dashboard | state | false |
| [DASHBOARD_PORT_IN_USE](./DASHBOARD_PORT_IN_USE.md) | dashboard | state | false |
| [DASHBOARD_PORT_INVALID](./DASHBOARD_PORT_INVALID.md) | dashboard | configuration | false |
| [DASHBOARD_PORT_REUSE](./DASHBOARD_PORT_REUSE.md) | dashboard | state | false |
...
| [DECISION_ADDED](./DECISION_ADDED.md) | decision | state | false |
...
| [EXTERNAL_CONVERTER_REQUIRED](./EXTERNAL_CONVERTER_REQUIRED.md) | external | configuration | false |
...
| [GEOMETRY_BUILD_FAILED](./GEOMETRY_BUILD_FAILED.md) | geometry build | state | false |
...
| [INTENT_DSL_INVALID_PACKS](./INTENT_DSL_INVALID_PACKS.md) | intent | state | false |
...
| [INVALID_SPEC_INTENT_PROVENANCE](./INVALID_SPEC_INTENT_PROVENANCE.md) | invalid | state | false |
| [INVALID_T2C_INTENT](./INVALID_T2C_INTENT.md) | invalid | state | false |
| [INVALID_T2C_INTENT_BIOXFOUNDRY](./INVALID_T2C_INTENT_BIOXFOUNDRY.md) | invalid | state | false |
| [INVALID_T2C_INTENT_EPISTEMIC](./INVALID_T2C_INTENT_EPISTEMIC.md) | invalid | state | false |
| [INVALID_T2C_INTENT_GENERATION](./INVALID_T2C_INTENT_GENERATION.md) | invalid | state | false |
| [INVALID_T2C_INTENT_KEYS](./INVALID_T2C_INTENT_KEYS.md) | invalid | state | false |
| [INVALID_T2C_INTENT_LIFECYCLE](./INVALID_T2C_INTENT_LIFECYCLE.md) | invalid | state | false |
| [INVALID_T2C_INTENT_METADATA](./INVALID_T2C_INTENT_METADATA.md) | invalid | state | false |
| [INVALID_T2C_INTENT_OBSERVED_AT](./INVALID_T2C_INTENT_OBSERVED_AT.md) | invalid | state | false |
...
| [INVALID_T2C_INTENT_SOURCE_ANCHOR](./INVALID_T2C_INTENT_SOURCE_ANCHOR.md) | invalid | state | false |
| [INVALID_T2C_INTENT_STATEMENT](./INVALID_T2C_INTENT_STATEMENT.md) | invalid | state | false |
| [INVALID_T2C_INTENT_TARGET](./INVALID_T2C_INTENT_TARGET.md) | invalid | state | false |
...
| [LLM_SCENE_PROPOSAL_REJECTED](./LLM_SCENE_PROPOSAL_REJECTED.md) | llm | policy | false |
| [LLM_TWIN_PROPOSAL_REJECTED](./LLM_TWIN_PROPOSAL_REJECTED.md) | llm | policy | false |
| [MAMMOTH_FAILED](./MAMMOTH_FAILED.md) | mammoth | state | false |
...
| [MQTT_ACK_INVALID](./MQTT_ACK_INVALID.md) | mqtt | configuration | false |
| [MQTT_ACK_UNEXPECTED](./MQTT_ACK_UNEXPECTED.md) | mqtt | state | false |
| [MQTT_BINDING_BLOCK_END_REQUIRED](./MQTT_BINDING_BLOCK_END_REQUIRED.md) | mqtt | configuration | false |
| [MQTT_BINDING_BROKER_INVALID](./MQTT_BINDING_BROKER_INVALID.md) | mqtt | configuration | false |
| [MQTT_BINDING_BROKER_NOT_STARTED](./MQTT_BINDING_BROKER_NOT_STARTED.md) | mqtt | state | false |
| [MQTT_BINDING_BROKER_UNKNOWN_KEY](./MQTT_BINDING_BROKER_UNKNOWN_KEY.md) | mqtt | configuration | false |
| [MQTT_BINDING_DEFAULT_MODE_UNROUTED](./MQTT_BINDING_DEFAULT_MODE_UNROUTED.md) | mqtt | state | false |
| [MQTT_BINDING_DOCUMENT_INVALID](./MQTT_BINDING_DOCUMENT_INVALID.md) | mqtt | configuration | false |
| [MQTT_BINDING_DOCUMENT_REQUIRED](./MQTT_BINDING_DOCUMENT_REQUIRED.md) | mqtt | configuration | false |
| [MQTT_BINDING_END_REQUIRED](./MQTT_BINDING_END_REQUIRED.md) | mqtt | configuration | false |
| [MQTT_BINDING_HEADER_REQUIRED](./MQTT_BINDING_HEADER_REQUIRED.md) | mqtt | configuration | false |
| [MQTT_BINDING_KEEP_ALIVE_INVALID](./MQTT_BINDING_KEEP_ALIVE_INVALID.md) | mqtt | configuration | false |
| [MQTT_BINDING_MODE_INVALID](./MQTT_BINDING_MODE_INVALID.md) | mqtt | configuration | false |
| [MQTT_BINDING_MODE_TOPIC_AMBIGUOUS](./MQTT_BINDING_MODE_TOPIC_AMBIGUOUS.md) | mqtt | state | false |
| [MQTT_BINDING_NOT_CONFIGURED](./MQTT_BINDING_NOT_CONFIGURED.md) | mqtt | availability | true |
| [MQTT_BINDING_QOS_INVALID](./MQTT_BINDING_QOS_INVALID.md) | mqtt | configuration | false |
| [MQTT_BINDING_ROUTE_INVALID](./MQTT_BINDING_ROUTE_INVALID.md) | mqtt | configuration | false |
| [MQTT_BINDING_ROUTE_NOT_STARTED](./MQTT_BINDING_ROUTE_NOT_STARTED.md) | mqtt | state | false |
| [MQTT_BINDING_ROUTE_UNKNOWN_KEY](./MQTT_BINDING_ROUTE_UNKNOWN_KEY.md) | mqtt | configuration | false |
| [MQTT_BINDING_TOPIC_DUPLICATE](./MQTT_BINDING_TOPIC_DUPLICATE.md) | mqtt | integrity | false |
| [MQTT_BINDING_TOPIC_INVALID](./MQTT_BINDING_TOPIC_INVALID.md) | mqtt | configuration | false |
| [MQTT_BINDING_TOPIC_PLACEHOLDER_INVALID](./MQTT_BINDING_TOPIC_PLACEHOLDER_INVALID.md) | mqtt | configuration | false |
| [MQTT_BINDING_TOPIC_WILDCARD_FORBIDDEN](./MQTT_BINDING_TOPIC_WILDCARD_FORBIDDEN.md) | mqtt | policy | false |
| [MQTT_BINDING_TRAILING_CONTENT](./MQTT_BINDING_TRAILING_CONTENT.md) | mqtt | state | false |
| [MQTT_BINDING_UNKNOWN_KEY](./MQTT_BINDING_UNKNOWN_KEY.md) | mqtt | configuration | false |
| [MQTT_CLIENT_CONNECT_IN_PROGRESS](./MQTT_CLIENT_CONNECT_IN_PROGRESS.md) | mqtt | state | true |
| [MQTT_CLIENT_NOT_CONNECTED](./MQTT_CLIENT_NOT_CONNECTED.md) | mqtt | state | false |
| [MQTT_CONNACK_REJECTED](./MQTT_CONNACK_REJECTED.md) | mqtt | policy | false |
| [MQTT_CONNACK_TIMEOUT](./MQTT_CONNACK_TIMEOUT.md) | mqtt | state | false |
| [MQTT_CONNECT_FAILED](./MQTT_CONNECT_FAILED.md) | mqtt | availability | true |
| [MQTT_CONNECT_TIMEOUT](./MQTT_CONNECT_TIMEOUT.md) | mqtt | state | false |
| [MQTT_CONNECTION_CLOSED](./MQTT_CONNECTION_CLOSED.md) | mqtt | state | false |
| [MQTT_DEMO_BROKER_NOT_FOUND](./MQTT_DEMO_BROKER_NOT_FOUND.md) | mqtt | configuration | false |
| [MQTT_DEMO_PROCESS_ENTRY_REQUIRED](./MQTT_DEMO_PROCESS_ENTRY_REQUIRED.md) | mqtt | configuration | false |
| [MQTT_DEMO_PROCESS_NOT_FOUND](./MQTT_DEMO_PROCESS_NOT_FOUND.md) | mqtt | configuration | false |
| [MQTT_DEMO_PROCESS_PATH_EMPTY](./MQTT_DEMO_PROCESS_PATH_EMPTY.md) | mqtt | state | false |
| [MQTT_DEMO_PROCESS_STEP_NOT_FOUND](./MQTT_DEMO_PROCESS_STEP_NOT_FOUND.md) | mqtt | configuration | false |
| [MQTT_DEMO_ROUTE_NOT_FOUND](./MQTT_DEMO_ROUTE_NOT_FOUND.md) | mqtt | configuration | false |
| [MQTT_DEMO_TOPIC_NOT_FOUND](./MQTT_DEMO_TOPIC_NOT_FOUND.md) | mqtt | configuration | false |
| [MQTT_MODE_INVALID](./MQTT_MODE_INVALID.md) | mqtt | configuration | false |
| [MQTT_MODE_UNAVAILABLE](./MQTT_MODE_UNAVAILABLE.md) | mqtt | state | false |
| [MQTT_PACKET_LENGTH_INVALID](./MQTT_PACKET_LENGTH_INVALID.md) | mqtt | configuration | false |
| [MQTT_PORT](./MQTT_PORT.md) | mqtt | state | false |
| [MQTT_PROCESS_EVENT_DOCUMENT_REQUIRED](./MQTT_PROCESS_EVENT_DOCUMENT_REQUIRED.md) | mqtt | configuration | false |
| [MQTT_PROCESS_EVENT_ENTRY_STEP_MISMATCH](./MQTT_PROCESS_EVENT_ENTRY_STEP_MISMATCH.md) | mqtt | integrity | false |
| [MQTT_PROCESS_EVENT_INITIAL_STATE_INVALID](./MQTT_PROCESS_EVENT_INITIAL_STATE_INVALID.md) | mqtt | configuration | false |
| [MQTT_PROCESS_EVENT_INVALID](./MQTT_PROCESS_EVENT_INVALID.md) | mqtt | configuration | false |
| [MQTT_PROCESS_EVENT_JSON_INVALID](./MQTT_PROCESS_EVENT_JSON_INVALID.md) | mqtt | configuration | false |
| [MQTT_PROCESS_EVENT_MODE_FORBIDDEN](./MQTT_PROCESS_EVENT_MODE_FORBIDDEN.md) | mqtt | policy | false |
| [MQTT_PROCESS_EVENT_OUT_OF_ORDER](./MQTT_PROCESS_EVENT_OUT_OF_ORDER.md) | mqtt | state | false |
| [MQTT_PROCESS_EVENT_ROUTE_MISMATCH](./MQTT_PROCESS_EVENT_ROUTE_MISMATCH.md) | mqtt | integrity | false |
| [MQTT_PROCESS_EVENT_SEQUENCE_GAP](./MQTT_PROCESS_EVENT_SEQUENCE_GAP.md) | mqtt | state | false |
| [MQTT_PROCESS_EVENT_STATE_TRANSITION_INVALID](./MQTT_PROCESS_EVENT_STATE_TRANSITION_INVALID.md) | mqtt | configuration | false |
| [MQTT_PROCESS_EVENT_STEP_INVALID](./MQTT_PROCESS_EVENT_STEP_INVALID.md) | mqtt | configuration | false |
| [MQTT_PROCESS_EVENT_STEP_REQUIRED](./MQTT_PROCESS_EVENT_STEP_REQUIRED.md) | mqtt | configuration | false |
| [MQTT_PROCESS_EVENT_STEP_TRANSITION_INVALID](./MQTT_PROCESS_EVENT_STEP_TRANSITION_INVALID.md) | mqtt | configuration | false |
| [MQTT_PROCESS_EVENT_TOO_LARGE](./MQTT_PROCESS_EVENT_TOO_LARGE.md) | mqtt | state | true |
| [MQTT_PROCESS_EVENT_TOPIC_MODE_MISMATCH](./MQTT_PROCESS_EVENT_TOPIC_MODE_MISMATCH.md) | mqtt | integrity | false |
| [MQTT_PROCESS_EVENT_UNKNOWN_KEY](./MQTT_PROCESS_EVENT_UNKNOWN_KEY.md) | mqtt | configuration | false |
| [MQTT_PROCESS_MODEL_NOT_AVAILABLE](./MQTT_PROCESS_MODEL_NOT_AVAILABLE.md) | mqtt | availability | true |
| [MQTT_PROCESS_REVISION_MISMATCH](./MQTT_PROCESS_REVISION_MISMATCH.md) | mqtt | integrity | false |
| [MQTT_PROCESS_ROUTE_PROCESS_NOT_FOUND](./MQTT_PROCESS_ROUTE_PROCESS_NOT_FOUND.md) | mqtt | configuration | false |
| [MQTT_PROCESS_RUN_IDENTITY_MISMATCH](./MQTT_PROCESS_RUN_IDENTITY_MISMATCH.md) | mqtt | integrity | false |
| [MQTT_PUBLISH_INVALID](./MQTT_PUBLISH_INVALID.md) | mqtt | configuration | false |
| [MQTT_PUBLISH_PACKET_ID_REQUIRED](./MQTT_PUBLISH_PACKET_ID_REQUIRED.md) | mqtt | configuration | false |
| [MQTT_QOS_UNSUPPORTED](./MQTT_QOS_UNSUPPORTED.md) | mqtt | state | false |
| [MQTT_STRING_TOO_LARGE](./MQTT_STRING_TOO_LARGE.md) | mqtt | state | true |
| [MQTT_SUBACK_REJECTED](./MQTT_SUBACK_REJECTED.md) | mqtt | policy | false |
| [MQTT_SUBSCRIBE_TOPICS_REQUIRED](./MQTT_SUBSCRIBE_TOPICS_REQUIRED.md) | mqtt | configuration | false |
| [MQTT_TOPIC_UNBOUND](./MQTT_TOPIC_UNBOUND.md) | mqtt | state | false |
| [MQTT_URL_INVALID](./MQTT_URL_INVALID.md) | mqtt | configuration | false |
| [MQTT_URL_NOT_CONFIGURED](./MQTT_URL_NOT_CONFIGURED.md) | mqtt | availability | true |
| [MQTT_URL_PROTOCOL_INVALID](./MQTT_URL_PROTOCOL_INVALID.md) | mqtt | configuration | false |
...
| [OUTPUT_CHANGED](./OUTPUT_CHANGED.md) | output | state | false |
| [OUTPUT_INSIDE_SOURCE](./OUTPUT_INSIDE_SOURCE.md) | output | state | false |
...
| [PROCESS_COMPONENT_UNMODELLED](./PROCESS_COMPONENT_UNMODELLED.md) | process | state | false |
...
| [PROCESS_KINEMATIC_MAPPING_MISSING](./PROCESS_KINEMATIC_MAPPING_MISSING.md) | process | state | false |
| [PROCESS_LABWARE_BINDING_MISSING](./PROCESS_LABWARE_BINDING_MISSING.md) | process | state | false |
...
| [PROCESS_TOOLPATH_MISSING](./PROCESS_TOOLPATH_MISSING.md) | process | state | false |
...
| [PYTHON_F2MD_BACKEND_TYPE_INVALID](./PYTHON_F2MD_BACKEND_TYPE_INVALID.md) | python | configuration | false |
...
| [SOURCE_SELECTION_HASH_MISMATCH](./SOURCE_SELECTION_HASH_MISMATCH.md) | source | integrity | false |
| [SOURCE_SELECTION_JSON_INVALID](./SOURCE_SELECTION_JSON_INVALID.md) | source | configuration | false |
| [SOURCE_SELECTION_PATH_DUPLICATE](./SOURCE_SELECTION_PATH_DUPLICATE.md) | source | integrity | false |
...
| [TEXT_FALLBACK](./TEXT_FALLBACK.md) | text | state | false |
...
| [TURNDOWN_FAILED](./TURNDOWN_FAILED.md) | turndown | state | false |
