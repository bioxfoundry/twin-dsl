...
code: SCENE_BLUEPRINT_PATH_DUPLICATE
source: error/catalog.json
generated: true
---

# SCENE_BLUEPRINT_PATH_DUPLICATE — Scene blueprint path duplicate
...
The scene blueprint path evidence is internally inconsistent or does not match its bound identity.
