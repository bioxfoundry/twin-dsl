...
code: SCENE_BLUEPRINT_COMPONENT_DUPLICATE
source: error/catalog.json
generated: true
---

# SCENE_BLUEPRINT_COMPONENT_DUPLICATE — Scene blueprint component duplicate
...
The scene blueprint component evidence is internally inconsistent or does not match its bound identity.
