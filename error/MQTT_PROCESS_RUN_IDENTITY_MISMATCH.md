...
code: MQTT_PROCESS_RUN_IDENTITY_MISMATCH
source: error/catalog.json
generated: true
---

# MQTT_PROCESS_RUN_IDENTITY_MISMATCH — Mqtt process run identity mismatch
...
The mqtt process run identity evidence is internally inconsistent or does not match its bound identity.
