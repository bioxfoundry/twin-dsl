...
code: TWIN_SOURCE_URI_NOT_GROUNDED
source: error/catalog.json
generated: true
---

# TWIN_SOURCE_URI_NOT_GROUNDED — Twin source uri not grounded
...
The twin source uri evidence is internally inconsistent or does not match its bound identity.
