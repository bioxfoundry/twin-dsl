...
code: SCENE_ASSET_NOT_GROUNDED
source: error/catalog.json
generated: true
---

# SCENE_ASSET_NOT_GROUNDED — Scene asset not grounded
...
The scene asset evidence is internally inconsistent or does not match its bound identity.
