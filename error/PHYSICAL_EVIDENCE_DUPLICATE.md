...
code: PHYSICAL_EVIDENCE_DUPLICATE
source: error/catalog.json
generated: true
---

# PHYSICAL_EVIDENCE_DUPLICATE — Physical evidence duplicate
...
The physical evidence evidence is internally inconsistent or does not match its bound identity.
