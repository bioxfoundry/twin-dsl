...
code: SOURCE_COVERAGE_HASH_MISMATCH
source: error/catalog.json
generated: true
---

# SOURCE_COVERAGE_HASH_MISMATCH — Source coverage hash mismatch
...
The source coverage evidence is internally inconsistent or does not match its bound identity.
