...
code: MUTATION_APPLY_GRANT_INVALID
source: error/catalog.json
generated: true
---

# MUTATION_APPLY_GRANT_INVALID — Mutation apply grant invalid
...
The mutation apply grant operation was refused by an explicit safety or authority boundary.
