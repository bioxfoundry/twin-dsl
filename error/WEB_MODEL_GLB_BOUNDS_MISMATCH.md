...
code: WEB_MODEL_GLB_BOUNDS_MISMATCH
source: error/catalog.json
generated: true
---

# WEB_MODEL_GLB_BOUNDS_MISMATCH — Web model glb bounds mismatch
...
The web model glb bounds evidence is internally inconsistent or does not match its bound identity.
