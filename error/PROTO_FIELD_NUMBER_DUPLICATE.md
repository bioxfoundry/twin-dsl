...
# PROTO_FIELD_NUMBER_DUPLICATE — Proto field number duplicate
...
The proto field number evidence is internally inconsistent or does not match its bound identity.
