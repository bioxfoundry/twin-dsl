...
code: mutation_grant_unreadable
source: error/catalog.json
generated: true
---

# mutation_grant_unreadable — Mutation grant unreadable
...
The mutation grant unreadable operation was refused by an explicit safety or authority boundary.
