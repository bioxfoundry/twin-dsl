...
code: mutation_grant_secret_missing
source: error/catalog.json
generated: true
---

# mutation_grant_secret_missing — Mutation grant secret missing
...
The mutation grant secret operation was refused by an explicit safety or authority boundary.
