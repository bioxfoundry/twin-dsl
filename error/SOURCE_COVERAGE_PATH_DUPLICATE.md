...
code: SOURCE_COVERAGE_PATH_DUPLICATE
source: error/catalog.json
generated: true
---

# SOURCE_COVERAGE_PATH_DUPLICATE — Source coverage path duplicate
...
The source coverage path evidence is internally inconsistent or does not match its bound identity.
