...
code: LIVING_WATCH_ALREADY_STARTED
source: error/catalog.json
generated: true
---

# LIVING_WATCH_ALREADY_STARTED — Living watch already started
...
The living watch operation cannot proceed in the current bounded runtime state.
