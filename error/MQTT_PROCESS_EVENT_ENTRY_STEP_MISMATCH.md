...
code: MQTT_PROCESS_EVENT_ENTRY_STEP_MISMATCH
source: error/catalog.json
generated: true
---

# MQTT_PROCESS_EVENT_ENTRY_STEP_MISMATCH — Mqtt process event entry step mismatch
...
The mqtt process event entry step evidence is internally inconsistent or does not match its bound identity.
