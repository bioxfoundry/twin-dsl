...
code: mutation_grant_field_required
source: error/catalog.json
generated: true
---

# mutation_grant_field_required — Mutation grant field required
...
The mutation grant field operation was refused by an explicit safety or authority boundary.
