...
code: mutation_grant_replay
source: error/catalog.json
generated: true
---

# mutation_grant_replay — Mutation grant replay
...
The mutation grant replay operation was refused by an explicit safety or authority boundary.
