...
code: MQTT_PROCESS_EVENT_ROUTE_MISMATCH
source: error/catalog.json
generated: true
---

# MQTT_PROCESS_EVENT_ROUTE_MISMATCH — Mqtt process event route mismatch
...
The mqtt process event route evidence is internally inconsistent or does not match its bound identity.
