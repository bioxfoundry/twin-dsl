...
code: mutation_grant_schema_invalid
source: error/catalog.json
generated: true
---

# mutation_grant_schema_invalid — Mutation grant schema invalid
...
The mutation grant schema operation was refused by an explicit safety or authority boundary.
