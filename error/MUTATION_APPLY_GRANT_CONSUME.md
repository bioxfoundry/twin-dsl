...
code: MUTATION_APPLY_GRANT_CONSUME
source: error/catalog.json
generated: true
---

# MUTATION_APPLY_GRANT_CONSUME — Mutation apply grant consume
...
The mutation apply grant consume operation was refused by an explicit safety or authority boundary.
