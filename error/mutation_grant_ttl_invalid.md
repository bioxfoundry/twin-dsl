...
code: mutation_grant_ttl_invalid
source: error/catalog.json
generated: true
---

# mutation_grant_ttl_invalid — Mutation grant ttl invalid
...
The mutation grant ttl operation was refused by an explicit safety or authority boundary.
